...
model_plant <- intersect(model_gpp_ec,model_2100_new)
...
models <- model_plant[begin:end] # for parallel 
  ...
  for(scenario in c('ssp245','ssp585')) {
    ...
    for (k in 1:10) {  # as pet always 2100
      ...
      terra::writeRaster(maps2,
                         paste0('/mnt/Fastrun/Canada_C/k/plant_climateonly_2100_20250109/',mk,'_','plant_climate_2100_',i,'_',scenario,'_',time00[k],'.tif'),overwrite = TRUE)
      # }
      h2o.shutdown(prompt = FALSE)
    }
  }}
