...
models00 <- model_plant_climate2300[begin:end] # for parallel
    ...
    for (k in 11:30) {
      ...
      for (j in 1:8) {
        ...
        stack_m <- h2o.loadModel(
          "/mnt/DataSpace/Projects/Canada_C/models_after_EC/bestfamiliy_ensemble/StackedEnsemble_BestOfFamily_4_AutoML_1_20240730_172301"
        )
        ...
        maps2 <- round(10^maps1, 1)
        names(maps2) <- 'Stack'
        terra::writeRaster(
          maps2,
          paste0(
            '/mnt/Fastrun/Canada_C/plant_climate2300_0813/',
            dep00[j],
            '_',
            'climate2300_',
            i,
