...
) # from /mnt/File0/DAAATAAA/Data_collection/Canada_soil_archive/Canada_SOC_rebuild/006_Update_after_EC_CSSS/001_h2o_automl_build_SOC_model.R
  ...
  for (scenario in c('ssp585')) {
    ...
    for (k in 1:30) {
      ...
      terra::writeRaster(
        maps2,
        paste0(
          '/mnt/Fastrun/Canada_C/k/plant_climateonly_585_2300/',
          mk,
          '_',
          'plant_climate_2300_',
          i,
